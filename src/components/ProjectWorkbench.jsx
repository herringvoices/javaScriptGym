...
export default function ProjectWorkbench({ projectId, entry, stepId }) {
  ...
  return <div className="overflow-hidden rounded-3xl border border-slate-800 bg-slate-950/70 p-0">
    <div className="flex items-center justify-between gap-2 border-b border-slate-800 px-3 py-2 text-xs text-slate-400"><span>Editor</span><span>Edits auto-save</span></div>
